...
int main() { 
    ...
    super_poder = (float)populacao1 + area1 + pib1 + num_pontos_turisticos1 +
    pib_per_capita1 + (1 / densidade_populacional);
    super_poder2 = (float)populacao2 + area2 + pib2 + num_pontos_turisticos2 +
